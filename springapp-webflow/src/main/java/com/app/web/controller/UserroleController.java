...
public class UserroleController {
	...
	@RequestMapping(value="/customer/addUserrole", method=RequestMethod.POST)
	public String addUserrole(@ModelAttribute(value="userrole") Userrole userrole, final BindingResult bindingResult, Model model)
	{
