...
/**
 * The persistent class for the statemonthly database table.
 * 
 */
@Entity
@Table(name = "statemonthly")
@NamedQuery(name="Statemonthly.findAll", query="SELECT s FROM Statemonthly s")
public class Statemonthly implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private StatemonthlyPK id;
	...
	public StatemonthlyPK getId() {
		return this.id;
	}

	public void setId(StatemonthlyPK id) {
		this.id = id;
	}
	...
	public String toString() {
		return "Statemonthly [id=" + id + ", newbusiness=" + newbusiness
